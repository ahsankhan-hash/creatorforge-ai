...
import { signupUser } from '@/lib/supabase/authHelper'
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-secondary text-center">
            Create an account to scale your YouTube production
          </p>
        </div>
        ...
        >
          <h2 className="font-display text-2xl font-bold mb-6 text-primary">Get started free</h2>
          ...
          {!isSupabaseConfigured && (
            <div className="mb-6 p-4 rounded-xl text-xs flex gap-2.5 items-start bg-amber-500/10 border border-amber-500/20 text-amber-400">
              ...
              <div>
                <span className="font-bold">Offline / Demo Mode active.</span> Local storage accounts are simulated. Enter any email and password to register.
              </div>
            </div>
          )}
